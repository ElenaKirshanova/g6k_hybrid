...
def solve_cvp(B, t, params):
    ...
    out_gs_reduced = g6k.randomized_iterative_slice([float(tt) for tt in t_gs_reduced],samples=nrand)
...
if __name__ == "__main__":
    ...
    filename = f"cvp_comp_{n}_{lat_num}_{inst_per_lat}_{betamax}_{appr_fact:0.4f}_ww.pkl"
    with open(filename,"wb") as file:
