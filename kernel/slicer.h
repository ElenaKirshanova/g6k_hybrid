...
static constexpr unsigned int XPC_SLICER_SAMPLING_THRESHOLD = 85; // XPC Threshold for iterative slicer sampling //75
static constexpr unsigned int XPC_SLICER_THRESHOLD = 100; // XPC Threshold for iterative slicer sampling //96
